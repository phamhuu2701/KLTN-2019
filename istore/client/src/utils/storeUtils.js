...
export function getProductCategoriesId(store) {
    ...
    for(let product of store.products){
        ...
        if(!checkProductCategoryIdExist(product.productCategory, productCategoriesId)){
...
export function checkProductCategoryIdExist(productCategoryId, productCategoriesId) {
