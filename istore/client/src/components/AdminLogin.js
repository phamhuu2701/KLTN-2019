	...
	render() {
		if (this.state.adminIsLoggedIn) {
			...
			<div className="limiter">
		        <div className="container-login100" style={{backgroundImage: 'url("./admin-bg.jpg")'}}>
		          	<div className="wrap-login100 p-t-30 p-b-50">
			            <span className="login100-form-title p-b-41">
			              Admin Login
			            </span>
			            <form action="admin" method="post" className="login100-form validate-form p-b-33 p-t-5" onSubmit={this.adminLoginHandler}>
